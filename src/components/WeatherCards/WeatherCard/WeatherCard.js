...
import { DAYS, WARNING } from "../../../commons/constants";
import "./WeatherCard.css";

class WeatherCard extends Component {
    animateOn = e => {
        const tempRight = e.currentTarget.getElementsByClassName(
            "temperature-two"
        )[0];
        const tempBottom = e.currentTarget.getElementsByClassName(
            "temperature"
        )[0];
            ...
            >
                ...
                <div className="description-cont">
                    <div className="description-cont-one">
                        <p className="description-title description-title-one">
                            Mañana
                        </p>
                    ...
                    <div className="description-cont-two">
                        <p className="description-title description-title-two">
                            Tarde
                        </p>
